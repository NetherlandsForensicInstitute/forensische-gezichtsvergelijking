...
- resources folder: datasets. Should have resources/enfsi/2011/-copy all images from that folder in the dataset-. Should also have resouces/lfw/ . Extract files from [here](https://drive.google.com/file/d/1uJZbV5SYtUm5a2p2Q5c8E-GnMDU7uT1O/view?usp=sharing).
- tests folder: TBD
### scripts
