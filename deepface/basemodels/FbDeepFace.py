...
def loadModel():
    ...
    base_model.add(Convolution2D(32,
                                 (11, 11),
                                 activation='relu',
                                 name='C1',
    ...
    base_model.add(MaxPooling2D(pool_size=3,
                                ...
                                padding='same',
                                name='M2'))
    base_model.add(Convolution2D(16,
                                 (9, 9),
                                 activation='relu',
                                 name='C3'))
    base_model.add(LocallyConnected2D(16,
                                      (9, 9),
                                      activation='relu',
                                      name='L4'))
    base_model.add(LocallyConnected2D(16,
    ...
    home = str(Path.home())
    path = home + '/.deepface/weights/VGGFace2_DeepFace_weights_val-0.9034.h5'
    ...
    embeddings = base_model.layers[-3].output
