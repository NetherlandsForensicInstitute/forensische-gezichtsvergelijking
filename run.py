...
def run(args):
    ...
    for row in tqdm(range(n_experiments)):
        ...
        data_params = (
            str(params_dict['datasets']),
            params_dict['fraction_test']
        )
...
def experiment(params,
    ...
    p = lr_system.scorer.predict_proba(data_provider.X_calibrate,
                                       data_provider.ids_calibrate)
