...
from lr_face.data_providers import get_data, make_pairs
...
def experiment(params, data_provider=None, make_plots_and_save_as=None):
    """
    ...
    :param make_plots_and_save_as: if str, save plots in this folder. If None, no plots
    """
